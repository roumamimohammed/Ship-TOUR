...
<nav class="navbar fixed-top navbar-expand-lg navbar-light bg-white">
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          ...
          <li class="nav-item">
              <a class="nav-link"  class="nav-link" href="<?= URLROOT.'/pages/index';?>">Home</a>
            </li>
            <li class="nav-item">
               <a class="nav-link" class="nav-link" href="<?= URLROOT.'/pages/reserve';?>">Offres</a>
             </li>
            
             <li class="nav-item">
               <a class="nav-link" href="#features">Commands</a>
             </li>
             </li>
          </ul>
        </div>
