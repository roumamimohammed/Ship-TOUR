...
<div class="container-fluid">
   <h1 class="text-center mb-5">Ports:<button type="button" class="btn btn-outline-dark rounded" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo">ADD</button>
   </h1>
               ...
               <table class="table table-hover">
                  ...
                  <tbody>
                     <?php foreach ($data as $port) : ?>
                        <tr>
                           <td style="color: white;"><?= $port['id_p'] ?></td>
                           <td style="color: white;"><?= $port['nom'] ?></td>
                           <td style="color: white;"><?= $port['pays'] ?></td>
                           <td style="color: white;"><a href="<?= '../Ports/deleteport/' . $port['id_p'] ?>"><i class="fa fa-trash" style="font-size:20px;color:black;"></i></a></td>
                        </tr>
                     <?php endforeach; ?>
                  </tbody>
               </table>
