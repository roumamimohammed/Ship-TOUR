...
<div class="container-fluid">
   <h1 class="text-center mb-5">Chambres:
      <button type="button" class="btn btn-outline-dark rounded" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo">ADD</button>
   </h1>
</div>
               ...
               <table class="table table-hover">
                  ...
                  <tbody>
                     <?php foreach ($data as $croisie) : ?>
                        ...
                        <tr>
                           <td style="color: white;"><?= $croisie['id_ch'] ?></td>
                           <td style="color: white;"><?= $croisie['nom'] ?></td>
                           <td style="color: white;"><?= $croisie['type'] ?></td>
                           <td style="color: white;"><?= $croisie['prix'] ?></td>
                           <td style="color: white;"><a href="<?= '../chambres/deletechambre/' . $croisie['id_ch'] ?>"><i class="fa fa-trash" style="font-size:20px;color:black;"></i></a></td>
                        </tr>
                     <?php endforeach; ?>
                  </tbody>
               </table>
