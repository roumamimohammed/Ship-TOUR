...
<div class="container-fluid">
    <h1 class="text-center mb-5">Navires: <button type="button" class="btn btn-outline-danger rounded" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo">ADD</button>
</h1>
</div>
    ...
    <tbody>
        <?php foreach($data as $navire) :?>
            <tr>
                ...
                <td><a href="<?= '../Navires/deletenavire/'.$navire['id_n'] ?>"><i class="fa fa-trash" style="font-size:20px;color:black;"></i></a></td>
            </tr> 
        <?php endforeach;?>
    </tbody>
  </table>
