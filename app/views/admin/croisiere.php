...
<div class="container-fluid">
  <h1 class="text-center mb-5">Croisières:<button type="button" id="btnaddCroisiere" class="btn btn-outline-dark rounded" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo">ADD</button></h1>
          ...
          <table class="table table-hover">
            ...
            <tbody>
              <?php foreach ($data3 as $croisie) : ?>
                ...
                <tr>
                  <td style="color: white;" ><?= $croisie['id_croisiere'] ?></td>
                  <td style="color: white;" ><?= $croisie['nom_crois'] ?></td>
                  <td style="color: white;" ><?= $croisie['nom_nav'] ?></td>
                  <td style="color: white;" ><?= $croisie['prix'] ?></td>
                  <td style="color: white;" ><?= $croisie['nbr_nuit'] ?></td>
                  <td style="color: white;" ><?= $croisie['port_dep'] ?></td>
                  <td style="color: white;" ><?= $croisie['date_depart'] ?></td>
                  <td style="color: white;" ><a href="<?= '../Croisieres/deletecroisiere/' . $croisie['id_croisiere'] ?>"><i class="fa fa-trash" style="font-size:20px;color:black;"></i></a></td>
                </tr>
              ...
              <div class="modal-body">
                <form action="../Croisieres/addcroisiere" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-dark rounded">Ajouter</button>
                  </div>
                </form>
